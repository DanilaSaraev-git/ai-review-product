...
- [Синтетические ТЗ с внесёнными ошибками](MTS/experiments/synthetic-specs/README.md): два документа по шаблону MTS в версиях с ошибками и без них, с реестром внесённых ошибок; контрольный набор для оценки ревью, экспертно не проверен.
